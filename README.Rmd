...
<!-- badges: start -->
[![R build status](https://github.com/R-Ladies-Sao-Paulo/SlidesRLadies/workflows/R-CMD-check/badge.svg)](https://github.com/R-Ladies-Sao-Paulo/SlidesRLadies/actions)
<!-- badges: end -->
...
- [ ] Criar um template Rmd com a apresentação - para facilitar para outros capítulos
